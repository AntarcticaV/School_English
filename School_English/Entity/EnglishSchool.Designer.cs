// Создание кода T4 для модели "C:\Учеба 2\Инструментальные средства разработки программного обеспечения\школа иностранных языков\School_English\School_English\Entity\EnglishSchool.edmx" включено. 
